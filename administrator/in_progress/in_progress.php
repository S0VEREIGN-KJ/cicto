...
<a href="filter_inprogress.php" style="float: right; margin-right: 300px; margin-top: 20px;">
...
<table style="display: inline-block; margin: 10px; border: 3px solid black; font-size: 24px;margin-left: 500px;">
    <tr>
      <th style=" border-bottom: 1px solid black;">In Progress Tickets:</th>   <!--TOTAL TICKETS SUMMARY-->
    </tr>
    <tr>
...
<br>
  ...
  <div style="display: flex; flex-direction: column; align-items: center; margin-top: 20px; line-height: 1; margin-left:50px;">
...
while ($row = $result->fetch_assoc()) {
  ...
  echo '<td><a href="#" onclick="openNav(' . $row["ticket_number"] . ')">View/Print</a></td>';
  echo "</tr>";
}
