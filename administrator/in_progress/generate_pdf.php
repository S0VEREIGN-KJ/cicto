...
$pdf->SetTitle('Filtered In Progress Tickets');



// Set header with generated date (Full month name, day, and year)
$pdf->SetHeaderData('', 0, 'Filtered In Progress Tickets', 'Generated on: ' . $current_date);
...
$html = '<h1 style="text-align: center;font-size:15pt;">Filtered In Progress Tickets</h1>';
...
$pdf->Output('filtered_In Progress_tickets.pdf', 'I');
