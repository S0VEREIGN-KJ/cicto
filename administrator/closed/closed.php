...
<a href="filter_closed.php" style="float: right; margin-right: 300px; margin-top: 20px;">
...
<table style="display: inline-block; margin: 10px; border: 3px solid black; font-size: 24px; margin-left: 500px">
    <tr>
      <th style="border-bottom: 1px solid black;">Closed Tickets:</th>   <!--TOTAL TICKETS SUMMARY-->
    </tr>
    <tr>
      <td style="border-bottom: 1px solid black;">
        <?php
        $query = "SELECT COUNT(*) AS closed_tickets FROM ticket WHERE status = 'Closed'";
        $result = mysqli_query($conn, $query);
        $row = mysqli_fetch_assoc($result);
        echo $row['closed_tickets'];
        ?>
      </td>
    </tr>
  </table>
