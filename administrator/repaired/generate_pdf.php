...
// SQL Query
$sql = "SELECT * FROM ticket WHERE status = 'Repaired'";
if ($filter_date) {
...
$pdf->SetTitle('Filtered Repaired Tickets');



// Set header with generated date (Full month name, day, and year)
$pdf->SetHeaderData('', 0, 'Filtered Repaired Tickets', 'Generated on: ' . $current_date);
...
$html = '<h1 style="text-align: center;font-size:15pt;">Filtered Repaired Tickets</h1>';
...
$pdf->Output('filtered_Repaired_tickets.pdf', 'I');
