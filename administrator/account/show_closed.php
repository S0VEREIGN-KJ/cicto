...
$query = "SELECT id_number, full_name, phone_number, email, office FROM account WHERE deleted = 1"; // show deleted accounts
if ($office) {
...
<a href="closed_accounts.php" style="float: left; margin-left: 300px; margin-top: 20px;">
...
<h2 style="
    ...
    width: fit-content;
">
    CLOSED Accounts on:<br><br> <?= htmlspecialchars($office) ?>
</h2>
<div class="user-list">
    <?php
...
<script>
    ...
    window.location.href = 'open_account.php?id=' + currentUserId + '&username=' + encodeURIComponent(username) + '&password=' + encodeURIComponent(password);
}
</script>
