...
$query = "SELECT id_number, full_name, phone_number, email 
          FROM technician 
...
.tooltip {
    ...
    padding: 5px; /* Padding */
    position: fixed; /* Position it */
    right: 1430px; /* Distance from the right */
    height: 50px; /* Button height */
...
<a href="accounts.php" style="float: left; margin-left: 300px; margin-top: 20px; text-decoration: none;">
...
<a href="closed_technician.php" style="float: right; margin-right: 100px; margin-top: 20px; text-decoration: none;">
    <button class="arrow-button" style="background-color:#AA0000; color: #fff; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer; display: flex; align-items: center; gap: 8px; font-weight: bold;">
        Closed Accounts List &rarr;
    </button>
</a>
...
<!-- Floating Action Button with custom tooltip -->
<div class="floating-container">
    <div id="floating-btn" onclick="openSignupOverlay()">
        <span>+</span>
    </div>
...
<form action="submit_signup.php" method="POST" id="signup-form">
    <div class="custom-overlay" id="signup-overlay" style="display:none;">
        <div class="custom-overlay-content" id="signup-overlay-content">
            <h3>Sign Up for an Account</h3>
            <div class="input-group">
                <label for="id_number">ID Number:</label>
                <input type="tel" class="form-control" name="id_number" placeholder="ID Number" id="id_number" required autocomplete="off"
            ...
            <div class="input-group">
                      ...
                      <span style="position: relative; top: -26px; left: 300px;">
                          <input 
                              type="checkbox" 
                              onclick="seePass()" 
                              title="Show Password" 
            ...
            <div class="input-group">
                ...
                <input type="text" id="middle_name" name="middle_name" placeholder="Middle Name" autocomplete="off">
            </div>
            <div class="input-group">
    ...
    <input type="tel" class="form-control" name="phone_number" placeholder="09XXXXXXXXX" id="phone_number" required autocomplete="off"
           ...
           oninput="this.value = this.value.replace(/\D+/g, '').slice(0, 11)">
            ...
            <div class="button-container">
                <button type="button" class="custom-overlay-close-btn" onclick="closeSignupOverlay()">Cancel</button>
                <button type="button" class="custom-overlay-close-btn" onclick="submitSignup()">Sign Up</button>
            </div>
        </div>
    </div>
</form>
...
<div class="custom-overlay" id="admin-confirmation-overlay">
    <div class="custom-overlay-content" id="admin-confirmation-content">
        ...
        <p>Please enter admin credentials to confirm the sign-up.</p>
        <div class="input-group">
...
function executeDelete() {
    ...
    $.post("delete_tech.php", { userId: currentUserId }, function(response) {
        if (response.success) {
