...
// SQL Query
$sql = "SELECT * FROM ticket WHERE status = 'Scheduled'";
if ($filter_date) {
...
$pdf->SetTitle('Filtered Scheduled Tickets');



// Set header with generated date (Full month name, day, and year)
$pdf->SetHeaderData('', 0, 'Filtered Scheduled Tickets', 'Generated on: ' . $current_date);
...
$html = '<h1 style="text-align: center;font-size:15pt;">Filtered Scheduled Tickets</h1>';
...
$pdf->Output('filtered_Scheduled_tickets.pdf', 'I');
