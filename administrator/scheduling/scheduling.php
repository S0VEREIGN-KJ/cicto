...
<a href="filter_scheduling.php" style="float: right; margin-right: 300px; margin-top: 20px;">
...
<table style="display: inline-block; margin: 10px; border: 3px solid black; font-size: 24px;margin-left: 500px">
    <tr>
      <th style="border-bottom: 1px solid black;">Scheduled Tickets:</th>   <!--TOTAL TICKETS SUMMARY-->
    </tr>
    <tr>
