...
// Prepare the query to get technician names
$technicianQuery = $conn->prepare("SELECT full_name FROM technician"); // Adjust table and column names if needed
$technicianQuery->execute();
$technicianResult = $technicianQuery->get_result();

// Fetch all technician names in an array
$technicians = [];
...
$diagnostic = ''; // or a suitable default value like null or an array, depending on your needs
$approved_by = '';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="stylesheet" type="text/css" href="logout.css?v=1.0">
    <script src="logout.js" defer></script>   
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script src="../login/auth.js"></script>  <!--login js-->
...
<a href="filter_home.php" style="float: right; margin-right: 300px; margin-top: 20px;">
...
<table style="display: inline-block; margin: 10px; border: 3px solid black; font-size: 24px;margin-left: 500px;">
    <tr>
      <th style="border-bottom: 1px solid black;">Incoming Tickets:</th>   <!--TOTAL TICKETS SUMMARY-->
    </tr>
    <tr>
...
<div id="myNav" class="overlay">
  ...
  <form action="update_home.php" method="post" autocomplete="off">
  ...
  <div class="overlay_form_group">
                ...
                <input type="text" id="ticket_number" name="ticket_number"  value="<?php echo $ticket_data['ticket_number']; ?>" readonly > <!-- date_req -->
            </div>
            
        <div class="overlay_form_group">
                <label for="serial_number">Serial No.</label>
                <input type="text" id="serial_number" name="serial_number"  value="<?php echo $ticket_data['serial_number']; ?>"  readonly> <!-- serial_number -->
            </div>

          <div class="overlay_form_group">
                <label for="datetime_req">Date and TIme Requested</label>
                <input type="datetime-local" id="datetime_req" name="datetime_req"  value="<?php echo $ticket_data['datetime_req']; ?>" readonly >    <!-- date requested -->
            </div>

          <div class="overlay_form_group">
                <label for="id_number">Employee ID</label>
                <input type="text" id="id_number" name="id_number" value="<?php echo $ticket_data['id_number']; ?>" readonly > <!-- id_number -->
            </div>
          <div class="overlay_form_group">
                <label for="req_name">Requester Name</label>
                <input type="text" id="req_name" name="req_name" value="<?php echo $ticket_data['req_name']; ?>" readonly > <!-- ful name -->
            </div>
          <div class="overlay_form_group">
                <label for="office">Office</label>
                <input type="text" id="office" name="office" value="<?php echo $ticket_data['office']; ?>" readonly > <!-- office -->
            </div>
          <div class="overlay_form_group">
                <label for="phone_number">Phone Number:</label>
                <input type="text" id="phone_number" name="phone_number"  value="<?php echo $ticket_data['phone_number']; ?>"readonly > <!-- phone_number -->
            </div>
            <div class="overlay_form_group">
                <label for="email">Email Address</label>
                <input type="text" id="email" name="email"  value="<?php echo $ticket_data['email']; ?>"readonly > <!-- email -->
            </div>
            <div class="overlay_form_group">
                <label for="subject">Subject</label>
                <input type="text" id="subject" name="subject"   value="<?php echo $ticket_data['subject']; ?>"  readonly><!-- subject -->
            </div>
 ...
 <div class="overlay_form_group">
            ...
            <div class="overlay_form_group">
                ...
                <input type="text" id="unit" name="unit"   readonly > <!-- unit -->
            </div>
      ...
      <div class="overlay_form_group">
                ...
                <input type="text" id="accessories" name="accessories"  readonly > <!-- unit -->
            </div>
 
            <!-- Additional Repair Information -->
            <div class="overlay_form_group">
                <label for="item_date_received" readonly>Item Date Received:</label><!-- item_date_received -->
                <input type="date" id="item_date_received" name="item_date_received" value="<?php echo $item_date_received; ?>" readonly>
            </div>

            <div class="overlay_form_group">
    <label for="received_by" placeholder= "Choose Technician">Received by:</label>
    <input id="received_by" name="received_by" readonly>
    </input>
</div>

<div class="overlay_form_group">
    <label for="assigned_name"  placeholder= "Choose Technician">Name of Technician:</label>
    <input id="assigned_name" name="assigned_name" readonly>
    ...
    <select id="priority" name="priority"  required value="<?php echo $priority; ?>" readonly><!-- status-->
