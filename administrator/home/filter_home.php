...
<a href="home.php" style="float: left; margin-left: 300px; margin-top: 20px;">
...
<div id="myNav" class="overlay">
 ...
 <div class="overlay_form_group">
     ...
     <div class="overlay_form_group">
            ...
            <div class="overlay_form_group">
                <label for="item_date_received" style="text-decoration: underline; color: green; font-weight:bold;">Item Date Received:</label><!-- item_date_received -->
                <input type="date" id="item_date_received" name="item_date_received" value="<?php echo $item_date_received; ?>" required>
            </div>

            <div class="overlay_form_group">
    <label for="received_by" style="text-decoration: underline; color: green; font-weight:bold;" placeholder= "Choose Technician">Received by:</label>
    <select id="received_by" name="received_by" required>
        <option value="" disabled selected>Select Technician</option>
        <?php foreach ($technicians as $technician) : ?>
            <option value="<?php echo htmlspecialchars($technician); ?>">
...
<div class="overlay_form_group">
    <label for="assigned_name" style="text-decoration: underline; color: green; font-weight:bold;" placeholder= "Choose Technician">Name of Technician:</label>
    <select id="assigned_name" name="assigned_name" required>
        <option value="" disabled selected>Select Technician</option>
        <?php foreach ($technicians as $technician) : ?>
            <option value="<?php echo htmlspecialchars($technician); ?>">
                <?php echo htmlspecialchars($technician); ?>
        ...
        <?php endforeach; ?>
            ...
            <div class="overlay_form_group">
                ...
                <input type="text" id="diagnostic" name="diagnostic" required value="<?php echo $diagnostic; ?>" required><!-- diagnostic-->
            </div>

            <div class="overlay_form_group">
            <label for="status" style="text-decoration: underline; color: green; font-weight:bold;">PRIORITY:</label>
    <select id="priority" name="priority"  required value="<?php echo $priority; ?>" required><!-- status-->
