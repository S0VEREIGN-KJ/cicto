...
$pdf->SetTitle('Filtered Pending Tickets');



// Set header with generated date (Full month name, day, and year)
$pdf->SetHeaderData('', 0, 'Filtered Pending Tickets', 'Generated on: ' . $current_date);
...
$html = '<h1 style="text-align: center;font-size:15pt;">Filtered Pending Tickets</h1>';
...
$pdf->Output('filtered_pending_tickets.pdf', 'I');
